...
extern unsigned int linear_base_va;

/* Convert between linear and kernel virtual addresses.  */
#define lintokv(la)	((unsigned int)(la) + linear_base_va)
#define kvtolin(va)	((unsigned int)(va) - linear_base_va)
